...
export const FooterNav = ({
  ...
  return (
    <>
      <div className="mt-3 px-6 3xl:py-4 md:px-[10%]  bottom-0 2xl:py-1 flex justify-between  text-xs 3xl:text-lg text-gray-300 w-full z-20 lg:px-[12%] 2xl:p-[24%] bg-sky-950 xl:bg-transparent">
