          ...
          <div className="text-2xl 3xl:text-4xl font-antiqua">
            {selectedBook?.creatorPhotoURL && (
              <div className="w-full flex justify-center">
                <div className="relative rounded-full w-24 2.5xl:w-32 3xl:w-40 aspect-square border-4 border-stone-700">
                  <Image
            ...
            <div
              className={
                "text-xl xl:text-2xl xl:leading-7 2xl:text-3xl 2.5xl:text-4xl 3xl:text-5xl  font-antiqua"
              }
            >
              <p className="text-xl xl:text-xl 2xl:text-2xl 2.5xl:text-3xl 3xl:text-4xl italics font-semibold">
                {" "}
                created by&nbsp;
              ...
              <p>
                ...
                <p>
                  <em>"{selectedBook.title}"</em>. If you did, why not give it a
                  like!
                </p>{" "}
